...
public class CreateTripActivity extends AppCompatActivity  implements
    ...
    HashMap<Integer, Restaurents> user_res_map;
    List<Restaurents> restaurents_list;
    List<Restaurents> user_restaurents_list;
    Button btnCreate;
    Button btnView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logout=(ImageButton)findViewById(R.id.imgLogout);
        ...
        tripName=(EditText)findViewById(R.id.edit_tripname);
        btnCreate=(Button)findViewById(R.id.btnCreate);
        btnView=(Button)findViewById(R.id.btnView);
        restaurents_list=new ArrayList<>();
        user_restaurents_list=new ArrayList<>();
        imageView=(ImageView)findViewById(R.id.imageCalender);
        mSelectedDate=(TextView)findViewById(R.id.selectedDate);
        mUserName=(TextView)findViewById(R.id.txtUserName);
        mAutocompleteTextView = (AutoCompleteTextView) findViewById(R.id.autoCompleteCity);
        mAutocompleteTextView.setThreshold(3);
      //  mNameView = (TextView) findViewById(R.id.name);
        if(getIntent()!=null && getIntent().getExtras()!=null)
        {
            userName= (String) getIntent().getExtras().getString("Name");
            userId=(String) getIntent().getExtras().getString("Id");
                ...
                if(response.isSuccessful())
                {
                    ...
                    try {
                        ...
                        for(int i=0;i<msg_arr.length();i++)
                        {
                           ...
                           /*
                            if(!user_res_map.containsKey(0))
                            {
                                user_res_map.put(0,restaurents);
                            }
                            else
                            {
                            }
    ...
    public boolean onMarkerClick(final Marker marker) {
        ...
        // show it
        alertDialog.show();
        for(Restaurents r:user_restaurents_list)
        {
    ...
    {
        EditText tripName=(EditText)findViewById(R.id.edit_tripname);
        TextView tripdate=(TextView)findViewById(R.id.selectedDate);
