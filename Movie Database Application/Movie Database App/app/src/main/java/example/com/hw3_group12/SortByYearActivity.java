...
public class SortByYearActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_sort_by_year);
        final ImageView img_prev = (ImageView) findViewById(R.id.imgPrevious);
        final ImageView img_first = (ImageView) findViewById(R.id.imgFirst);
        final ImageView img_next = (ImageView) findViewById(R.id.imgNext);
        final ImageView img_last = (ImageView) findViewById(R.id.imgLast);
        final Button btnFinish = (Button) findViewById(R.id.btnFinish);
        final TextView Movie_title = (TextView) findViewById(R.id.main_movie_title);
        final TextView Movie_Desc = (TextView) findViewById(R.id.main_MovieDescription);
        final TextView Movie_Genre = (TextView) findViewById(R.id.main_genre);
        final TextView Movie_Rating = (TextView) findViewById(R.id.main_rating);
        final TextView Movie_Year = (TextView) findViewById(R.id.main_Year);
        final TextView Movie_IMDB = (TextView) findViewById(R.id.main_IMDB);
