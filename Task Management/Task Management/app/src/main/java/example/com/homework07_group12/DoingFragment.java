...
public class DoingFragment extends Fragment {
    ...
    private DoingInterface mListener;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        recyclerView = (RecyclerView) getView().findViewById(R.id.recyclerDoing);
    ...
    public void setListView() {
        ...
        DatabaseReference fetchTasks = database.getReference("Tasks/doing/");
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof DoingInterface) {
            mListener = (DoingInterface) context;
        } else {
